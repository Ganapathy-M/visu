(function () {
  ...
  (function () {
    ...
    Spark = (function () {
      ...
      Spark.prototype.init = function () {
        ...
        this.sparks = helpers.cloneBits(
          $proto,
          this.o.cnt || helpers.rand(10, 20)
        );
        size = this.o.size || 2;
        _ref = this.sparks;
        _results = [];
  ...
  (function () {
    ...
    Drop = (function () {
      ...
      Drop.prototype.init = function () {
        ...
        return (this.$els = helpers.cloneBits(
          this.$proto,
          this.cnt,
          this.o.$container
        ));
      ...
      CloudBit.prototype.setAttrs = function () {
        ...
        return this.$el
          .css({
            ...
            marginLeft:
              -this.o.width / 2 +
              ((_base = this.o).shiftX != null
                ? _base.shiftX
                : (_base.shiftX = 0)),
            marginTop:
              -this.o.height / 2 +
              ((_base1 = this.o).shiftY != null
                ? _base1.shiftY
                : (_base1.shiftY = 0)),
            opacity: 0
          })
          ...
          _results.push(
            $child
              .velocity(
                ...
                {
                  delay:
                    (delay + 160 + (this.fastChilds.length - i) * 15) * this.s,
                  duration: 100 * this.s
                }
              )
              .velocity(
  ...
  !(function (e, t, a, r) {
    ...
    function l(t) {
      if (t)
        for (
          var a = new Date().getTime(), o = 0, i = e.velocity.State.calls.length;
          i > o;
          o++
        )
          if (e.velocity.State.calls[o]) {
            ...
            for (
              var y = Math.min((a - f) / d.duration, 1), m = 0, h = g.length;
              h > m;
              m++
            ) {
              var v = g[m],
              ...
              if (e.data(x, u)) {
                ...
                d.display &&
                  "none" !== d.display &&
                  (p.setPropertyValue(x, "display", d.display),
                  (e.velocity.State.calls[o][2].display = !1));
                for (var b in v)
                  if ("element" !== b) {
                    var V = v[b],
                      S = V.currentValue,
                    ...
                    if (1 === y) k = V.endValue;
                      ...
                      ((k =
                        V.startValue +
                        (V.endValue - V.startValue) * e.easing[V.easing](y)),
                      !/translate/i.test(b) &&
                        y > 0.2 &&
                        0.8 > y &&
                        ("px" === V.unitType || "" === V.unitType) &&
                        Math.abs((k - S) / S) < 0.005)
                    )
                      break;
                    if (((V.currentValue = k), p.Hooks.registered[b])) {
                      var w = p.Hooks.getRoot(b),
                        C = e.data(x, u).rootPropertyValueCache[w];
                      C && (V.rootPropertyValue = C);
                    }
                    var T = p.setPropertyValue(
                      x,
                      b,
                      V.currentValue + ("auto" === k ? "" : V.unitType),
                      V.rootPropertyValue
                    );
                    p.Hooks.registered[b] &&
                      (e.data(x, u).rootPropertyValueCache[w] = p.Normalizations
                        .registered[w]
                        ? p.Normalizations.registered[w]("extract", null, T[1])
                        : T[1]),
                      "transform" === T[0] && (P = !0);
                  }
                d.mobileHA &&
                  (e.data(x, u).transformCache.translate3d === r
                    ? ((e.data(x, u).transformCache.translate3d = "(0, 0, 0)"),
                      (P = !0))
                    : 1 === y &&
                      (delete e.data(x, u).transformCache.translate3d, (P = !0))),
                  P && p.flushTransformCache(x);
              }
            }
            1 === y && n(o);
          }
    ...
    function n(t) {
      for (
        var a = e.velocity.State.calls[t][0],
          o = e.velocity.State.calls[t][1],
          i = e.velocity.State.calls[t][2],
          l = !1,
          n = 0,
          s = a.length;
        s > n;
        ...
        "none" === i.display &&
          i.loop === !1 &&
          p.setPropertyValue(c, "display", i.display),
          (e.queue(c)[1] !== r &&
            /\$\.velocity\.queueEntryFlag/i.test(e.queue(c)[1])) ||
            (e.data(c, u) &&
              ((e.data(c, u).isAnimating = !1),
              (e.data(c, u).rootPropertyValueCache = {}))),
          e.dequeue(c);
      }
      ...
      l === !1 &&
        ((e.velocity.State.isTicking = !1),
        delete e.velocity.State.calls,
        (e.velocity.State.calls = [])),
        i.complete && i.complete.call(o);
    }
    var s = (function () {
    ...
    if (e.velocity !== r || e.fn.velocity !== r)
      return void console.log(
        "Velocity is already loaded or its namespace is occupied."
      );
    !(function () {
      var t = {};
      e.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (e, a) {
        ...
        e.extend(t, {
          ...
          Bounce: function (e) {
            ...
            return (
              1 / Math.pow(4, 3 - a) - 7.5625 * Math.pow((3 * t - 2) / 22 - e, 2)
            );
          }
        }),
    ...
    (e.velocity = {
      ...
      Classes: { extracted: {}, extract: function () {} },
      CSS: {},
      animate: function () {},
      debug: !1
    }),
      t.pageYOffset !== r
        ? ((e.velocity.State.scrollAnchor = t),
          (e.velocity.State.scrollProperty = "pageYOffset"))
        : ((e.velocity.State.scrollAnchor =
            a.documentElement || a.body.parentNode || a.body),
          (e.velocity.State.scrollProperty = "scrollTop")),
      (e.velocity.Classes.extract = function () {
        ...
        return (
          (e.velocity.Classes.extracted = r),
          e.velocity.debug &&
            console.log(
              "Classes: " + JSON.stringify(e.velocity.Classes.extracted)
            ),
          r
        );
      }),
      e.velocity.Classes.extract();
    var p = (e.velocity.CSS = {
      ...
      Hooks: {
          ...
          if (s)
            for (e in p.Hooks.templates) {
              ...
              "Color" === a[0] &&
                (a.push(a.shift()),
                r.push(r.shift()),
                (p.Hooks.templates[e] = [a.join(" "), r.join(" ")]));
            }
          for (e in p.Hooks.templates) {
            (t = p.Hooks.templates[e]), (a = t[0].split(" "));
            for (var o in a) {
        ...
        cleanRootPropertyValue: function (e, t) {
          return (
            p.RegEx.valueUnwrap.test(t) &&
              (t = t.match(p.Hooks.RegEx.valueUnwrap)[1]),
            p.Values.isCSSNullValue(t) && (t = p.Hooks.templates[e][1]),
            t
          );
        },
        extractValue: function (e, t) {
          ...
          if (a) {
            var r = a[0],
              o = a[1];
            return (
              (t = p.Hooks.cleanRootPropertyValue(r, t)),
              t.toString().match(p.RegEx.valueSplit)[o]
            );
          }
          return t;
        },
        injectValue: function (e, t, a) {
          ...
          if (r) {
            var o = r[0],
              ...
              n;
            return (
              (a = p.Hooks.cleanRootPropertyValue(o, a)),
              (l = a.toString().match(p.RegEx.valueSplit)),
              (l[i] = t),
              (n = l.join(" "))
            );
          }
          ...
          clip: function (e, t, a) {
            switch (e) {
              ...
              case "extract":
                var r;
                return (
                  p.RegEx.wrappedValueAlreadyExtracted.test(a)
                    ? (r = a)
                    : ((r = a.toString().match(p.RegEx.valueUnwrap)),
                      r && (r = r[1].replace(/,(\s+)?/g, " "))),
                  r
                );
              case "inject":
          ...
          opacity: function (e, t, a) {
            if (8 >= s)
              switch (e) {
                ...
                case "inject":
                  return (
                    (t.style.zoom = 1), "alpha(opacity=" + parseInt(100 * a) + ")"
                  );
              }
            else
              switch (e) {
        ...
        register: function () {
          function t(e) {
            var t = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
              ...
              r;
            return (
              (e = e.replace(t, function (e, t, a, r) {
                return t + t + a + a + r + r;
              })),
              (r = a.exec(e)),
              r
          ...
          9 >= s ||
            (a = a.concat(["translateZ", "scaleZ", "rotateX", "rotateY"]));
          for (var o = 0, i = a.length; i > o; o++)
            !(function () {
              var t = a[o];
              p.Normalizations.registered[t] = function (a, o, i) {
                switch (a) {
                  case "name":
                    return "transform";
                  case "extract":
                    return e.data(o, u).transformCache[t] === r
                      ? /^scale/i.test(t)
                        ? 1
                        : 0
                      : e.data(o, u).transformCache[t].replace(/[()]/g, "");
                  case "inject":
                    var l = !1;
                    ...
                    return (
                      l || (e.data(o, u).transformCache[t] = "(" + i + ")"),
                      e.data(o, u).transformCache[t]
                    );
                }
              };
            })();
          for (
            var l = ["color", "backgroundColor", "borderColor", "outlineColor"],
              o = 0,
              n = l.length;
            n > o;
            o++
                ...
                switch (a) {
                  ...
                  case "extract":
                    ...
                    if (p.RegEx.wrappedValueAlreadyExtracted.test(i)) l = i;
                      ...
                      /^[A-z]+$/i.test(i)
                        ? (n = c[i] !== r ? c[i] : c.black)
                        : /^#([A-f\d]{3}){1,2}$/i.test(i)
                        ? (n = t(i))
                        : /^rgba?\(/i.test(i) || (n = c.black),
                        (l = (n || i)
                          .toString()
                          .match(p.RegEx.valueUnwrap)[1]
                          .replace(/,(\s+)?/g, " "));
                    }
      ...
      Names: {
        ...
        prefixCheck: function (t) {
          ...
          for (
            var a = ["", "Webkit", "Moz", "ms", "O"], r = 0, o = a.length;
            o > r;
            r++
          ) {
            var i;
            if (
              ...
              "string" == typeof e.velocity.State.prefixElement.style[i])
            )
              return (e.velocity.State.prefixMatches[t] = i), [i, !0];
          }
          return [t, !1];
        }
      },
      ...
      getPropertyValue: function (a, o, i, l) {
        function n(a, o) {
          if (!l) {
            if (
              "height" === o &&
              "border-box" !== p.getPropertyValue(a, "boxSizing").toLowerCase()
            )
              return (
                a.offsetHeight -
                (parseFloat(p.getPropertyValue(a, "borderTopWidth")) || 0) -
                (parseFloat(p.getPropertyValue(a, "borderBottomWidth")) || 0) -
                (parseFloat(p.getPropertyValue(a, "paddingTop")) || 0) -
                (parseFloat(p.getPropertyValue(a, "paddingBottom")) || 0)
              );
            if (
              "width" === o &&
              "border-box" !== p.getPropertyValue(a, "boxSizing").toLowerCase()
              ...
              return (
                a.offsetWidth -
                (parseFloat(p.getPropertyValue(a, "borderLeftWidth")) || 0) -
                (parseFloat(p.getPropertyValue(a, "borderRightWidth")) || 0) -
                (parseFloat(p.getPropertyValue(a, "paddingLeft")) || 0) -
                (parseFloat(p.getPropertyValue(a, "paddingRight")) || 0)
              );
          }
          var i = 0;
          if (8 >= s) i = e.css(a, o);
            ...
            (c =
              e.data(a, u) === r
                ? t.getComputedStyle(a, null)
                : e.data(a, u).computedStyle
                ? e.data(a, u).computedStyle
                : (e.data(a, u).computedStyle = t.getComputedStyle(a, null))),
              s && "borderColor" === o && (o = "borderTopColor"),
              (i = 9 === s && "filter" === o ? c.getPropertyValue(o) : c[o]),
              "" === i && (i = a.style[o]);
          }
          if ("auto" === i && /^(top|right|bottom|left)$/i.test(o)) {
            var g = n(a, "position");
            ("fixed" === g || ("absolute" === g && /top|left/i.test(o))) &&
              (i = e(a).position()[o] + "px");
          }
          return i;
        }
        ...
        if (p.Hooks.registered[o]) {
          var g = o,
            d = p.Hooks.getRoot(g);
          i === r && (i = p.getPropertyValue(a, p.Names.prefixCheck(d)[0])),
            p.Normalizations.registered[d] &&
              (i = p.Normalizations.registered[d]("extract", a, i)),
            (c = p.Hooks.extractValue(g, i));
        } else if (p.Normalizations.registered[o]) {
          var f, y;
          (f = p.Normalizations.registered[o]("name", a)),
            "transform" !== f &&
              ((y = n(a, p.Names.prefixCheck(f)[0])),
              p.Values.isCSSNullValue(y) &&
                p.Hooks.templates[o] &&
                (y = p.Hooks.templates[o][1])),
            (c = p.Normalizations.registered[o]("extract", a, y));
        }
        return (
          /^[\d-]/.test(c) || (c = n(a, p.Names.prefixCheck(o)[0])),
          p.Values.isCSSNullValue(c) && (c = 0),
          e.velocity.debug >= 2 && console.log("Get " + o + ": " + c),
          c
        );
      },
      setPropertyValue: function (a, r, o, i) {
        ...
        if ("scroll" === r) t.scrollTo(null, o);
          ...
          p.Normalizations.registered[r] &&
          "transform" === p.Normalizations.registered[r]("name", a)
        )
          p.Normalizations.registered[r]("inject", a, o),
            (l = "transform"),
            (o = e.data(a, u).transformCache[r]);
        else {
          if (p.Hooks.registered[r]) {
            var n = r,
              c = p.Hooks.getRoot(r);
            (i = i || p.getPropertyValue(a, c)),
              (o = p.Hooks.injectValue(n, o, i)),
              (r = c);
          }
          if (
            (p.Normalizations.registered[r] &&
              ((o = p.Normalizations.registered[r]("inject", a, o)),
              (r = p.Normalizations.registered[r]("name", a))),
            (l = p.Names.prefixCheck(r)[0]),
            8 >= s)
          )
            try {
              a.style[l] = o;
      ...
      flushTransformCache: function (t) {
        var a = "",
          r,
          o;
        for (r in e.data(t, u).transformCache)
          (o = e.data(t, u).transformCache[r]),
            9 === s && "rotateZ" === r && (r = "rotate"),
            (a += r + o + " ");
        p.setPropertyValue(t, "transform", a);
      }
    });
    p.Hooks.register(),
      p.Normalizations.register(),
      (e.fn.velocity = e.velocity.animate = function () {
        function t() {
          var t = this,
            n = e.extend(
              {},
              e.fn.velocity.defaults,
              e.data(t, "uiVelocityOptions"),
              g
            ),
            d = {};
          if ("stop" === y)
          ...
          switch (
            ...
            default:
              n.duration =
                ...
                parseFloat(e.fn.velocity.defaults.duration) ||
                400;
          }
          e.easing[n.easing] ||
            (n.easing = e.easing[e.fn.velocity.defaults.easing]
              ? e.fn.velocity.defaults.easing
              : "swing"),
            /^\d/.test(n.delay) &&
              e.queue(t, n.queue, function (t) {
                (e.velocity.queueEntryFlag = !0),
                  setTimeout(t, parseFloat(n.delay));
              }),
            n.display && (n.display = n.display.toLowerCase()),
            (n.mobileHA = n.mobileHA && e.velocity.State.isMobile),
            e.queue(t, n.queue, function (f) {
              function m(a) {
                var o = r,
                  l = r,
                  s = r;
              ...
              function V() {
                ...
                (P.lastParent = r.parent),
                  (P.lastPosition = r.position),
                  (P.lastFontSize = r.fontSize),
                  null === P.remToPxRatio &&
                    (P.remToPxRatio =
                      parseFloat(p.getPropertyValue(a.body, "fontSize")) || 16);
                var l = {
                    overflowX: null,
                    overflowY: null,
                    boxSizing: null,
                  ...
                  n = {},
                  s = 10;
                (n.remToPxRatio = P.remToPxRatio),
                  (l.overflowX = p.getPropertyValue(t, "overflowX")),
                  (l.overflowY = p.getPropertyValue(t, "overflowY")),
                  (l.boxSizing = p.getPropertyValue(t, "boxSizing")),
                  (l.width = p.getPropertyValue(t, "width", null, !0)),
                  (l.minWidth = p.getPropertyValue(t, "minWidth")),
                  (l.maxWidth = p.getPropertyValue(t, "maxWidth") || "none"),
                  (l.height = p.getPropertyValue(t, "height", null, !0)),
                  (l.minHeight = p.getPropertyValue(t, "minHeight")),
                  (l.maxHeight = p.getPropertyValue(t, "maxHeight") || "none"),
                  (l.paddingLeft = p.getPropertyValue(t, "paddingLeft")),
                  o
                    ? ((n.percentToPxRatioWidth = P.lastPercentToPxWidth),
                      (n.percentToPxRatioHeight = P.lastPercentToPxHeight))
                    : (p.setPropertyValue(t, "overflowX", "hidden"),
                      p.setPropertyValue(t, "overflowY", "hidden"),
                      p.setPropertyValue(t, "boxSizing", "content-box"),
                      p.setPropertyValue(t, "width", s + "%"),
                      p.setPropertyValue(t, "minWidth", s + "%"),
                      p.setPropertyValue(t, "maxWidth", s + "%"),
                      p.setPropertyValue(t, "height", s + "%"),
                      p.setPropertyValue(t, "minHeight", s + "%"),
                      p.setPropertyValue(t, "maxHeight", s + "%")),
                  i
                    ? (n.emToPxRatio = P.lastEmToPx)
                    : p.setPropertyValue(t, "paddingLeft", s + "em"),
                  o ||
                    ((n.percentToPxRatioWidth = P.lastPercentToPxWidth =
                      (parseFloat(p.getPropertyValue(t, "width", null, !0)) ||
                        0) / s),
                    (n.percentToPxRatioHeight = P.lastPercentToPxHeight =
                      (parseFloat(p.getPropertyValue(t, "height", null, !0)) ||
                        0) / s)),
                  i ||
                    (n.emToPxRatio = P.lastEmToPx =
                      (parseFloat(p.getPropertyValue(t, "paddingLeft")) || 0) /
                      s);
              ...
              if (((e.velocity.queueEntryFlag = !0), "scroll" === y)) {
                var S =
                    e.velocity.State.scrollAnchor[
                      e.velocity.State.scrollProperty
                    ],
                ...
                if (!e.data(t, u).tweensContainer)
                  return void e.dequeue(t, n.queue);
                "none" === e.data(t, u).opts.display &&
                  (e.data(t, u).opts.display = "block"),
                  (e.data(t, u).opts.loop = !1),
                  (n = e.extend({}, e.data(t, u).opts, g));
                var w = e.extend(!0, {}, e.data(t, u).tweensContainer);
                for (var C in w)
                  if ("element" !== C) {
                    var T = w[C].startValue;
                    (w[C].startValue = w[C].currentValue = w[C].endValue),
                      (w[C].endValue = T),
                      g && (w[C].easing = n.easing);
                  }
                d = w;
              } else if ("start" === y) {
                var w;
                e.data(t, u).tweensContainer &&
                  e.data(t, u).isAnimating === !0 &&
                  (w = e.data(t, u).tweensContainer);
                for (var H in c) {
                  ...
                  var R = m(c[H]),
                    ...
                    F = !1;
                  if (
                    p.Names.prefixCheck(E)[1] !== !1 ||
                    p.Normalizations.registered[E] !== r
                  ) {
                    n.display &&
                      "none" !== n.display &&
                      ...
                      0 !== z &&
                      (A = 0),
                      n._cacheValues && w && w[H]
                        ? ((A = w[H].endValue + w[H].unitType),
                          (F = e.data(t, u).rootPropertyValueCache[E]))
                        : p.Hooks.registered[H]
                        ? A === r
                          ? ((F = p.getPropertyValue(t, E)),
                            (A = p.getPropertyValue(t, H, F)))
                          : (F = p.Hooks.templates[E][1])
                        : A === r && (A = p.getPropertyValue(t, H));
                    var M, q, j, W;
                    (M = h(H, A)),
                      (A = M[0]),
                      (j = M[1]),
                      (M = h(H, z)),
                      (z = M[0].replace(/^([+-\/*])=/, function (e, t) {
                        return (W = t), "";
                      })),
                      (q = M[1]),
                      (A = parseFloat(A) || 0),
                    ...
                    (d[H] = {
                      ...
                      e.velocity.debug &&
                        console.log(
                          "tweensContainer (" + H + "): " + JSON.stringify(d[H]),
                          t
                        );
                  } else
                    e.velocity.debug &&
                      console.log(
                        "Skipping [" + E + "] due to a lack of browser support."
                      );
                }
                d.element = t;
              }
              d.element &&
                (b.push(d),
                (e.data(t, u).tweensContainer = d),
                (e.data(t, u).opts = n),
                (e.data(t, u).isAnimating = !0),
                x === v - 1
                  ? (e.velocity.State.calls.length > 1e4 &&
                      (e.velocity.State.calls = o(e.velocity.State.calls)),
                    e.velocity.State.calls.push([b, s, n]),
                    e.velocity.State.isTicking === !1 &&
                      ((e.velocity.State.isTicking = !0), l()))
                  : x++),
                "" !== n.queue &&
                  "fx" !== n.queue &&
                  setTimeout(f, n.duration + n.delay);
            }),
            (n.queue === !1 ||
              (("" === n.queue || "fx" === n.queue) &&
                "inprogress" !== e.queue(t)[0])) &&
              e.dequeue(t);
        }
        var n, s, c, g, d, f;
        this.jquery
          ? ((n = !0), (s = this), (c = arguments[0]), (g = arguments[1]))
          : ((n = !1),
            (s = arguments[0]),
            (c = arguments[1]),
            (g = arguments[2]));
        ...
        switch (c) {
          ...
          default:
            if (e.isPlainObject(c) && !e.isEmptyObject(c)) y = "start";
              ...
              if ("string" != typeof c || !e.velocity.Classes.extracted[c])
                return (
                  e.velocity.debug &&
                    console.log(
                      "First argument was not a property map, a CSS class reference, or a known action. Aborting."
                    ),
                  s
                );
        ...
        if ("stop" !== y && "object" != typeof g) {
          var m = n ? 1 : 2;
          g = {};
          for (var h = m; h < arguments.length; h++)
            /^\d/.test(arguments[h])
              ? (g.duration = parseFloat(arguments[h]))
              : "string" == typeof arguments[h]
              ? (g.easing = arguments[h].replace(/^\s+|\s+$/g, ""))
              : i(arguments[h]) && (g.complete = arguments[h]);
        }
        var v = s.length || 1,
          x = 0,
          P = {
        ...
        else if (s[0] && s[0].nodeType) for (var V in s) t.call(s[V]);
        var S = e.extend({}, e.fn.velocity.defaults, g);
        if (((S.loop = parseInt(S.loop)), S.loop))
          for (var k = 0; k < 2 * S.loop - 1; k++)
            n
              ? s.velocity("reverse", { delay: S.delay })
              : e.velocity.animate(s, "reverse", { delay: S.delay });
        return s;
      });
